...
pdf(file = './Fig1-b-surv-v1-2023-10-18.pdf', width = 4.5, height = 5)
ggsurvplot(fit1, data = df, ylim = c(0.5, 1), palette = c('blue', 'cyan', 'red'))
dev.off()

write.csv(df, './Fig1-b-21-Z-D-event-event.time-v1-2023-10-18.csv', 
          fileEncoding = 'GB2312')

pdf(file = './Fig1-b-likelihood-v1-2023-10-18.pdf', width = 4, height = 5)
...
write.csv(data.frame(alphas = alphas, 
          ...
          './Fig1-b-21-alphas-likelihoods-v1-2023-10-18.csv', 
          fileEncoding = 'GB2312')
...
for (kk in 1:length(eta.range)) {
  ...
  write.csv(alpha.array, paste0('./Fig1-c-alpha-array-eta = ', eta, '-v1-2023-10-18.csv'), 
            fileEncoding = 'GB2312')
  write.csv(D.array, paste0('./Fig1-c-D-array-eta = ', eta, '-v1-2023-10-18.csv'), 
            fileEncoding = 'GB2312')
  write.csv(Z.array, paste0('./Fig1-c-Z-array-eta = ', eta, '-v1-2023-10-18.csv'), 
            fileEncoding = 'GB2312')
...
for (kk in 1:length(eta.range)) {
  for (jj in 1:length(alpha.range)) {
    ...
    write.csv(df.plot, paste0('./Fig2-asy-', alpha, '-', eta, '-v1-2023-10-18.csv'),
              fileEncoding = 'GB2312')
    ...
    pdf(paste0('./Fig2-asy-', alpha, '-', eta, '-v1-2023-10-18.pdf'), width = 5, height = 5)
...
write.csv(data.frame(N = N.range, run.time = run.time), 
          './Fig3-a-LATEst-run-time-v1-2023-10-18.csv', fileEncoding = 'GB2312')

pdf('./Fig3-a-LATEst-run-time-v1-2023-10-18.pdf', width = 5, height = 5)
plot(N.range, run.time, ylim = c(0, 0.6), pch = 20,
     xlab = 'N', ylab = 'LATEst run time (sec)')
dev.off()
...
pdf(file = './Fig4-b-picc-surv-v1-2023-10-18.pdf', width = 4.5, height = 5)
ggsurvplot(fit1, data = df, ylim = c(0.7, 1), palette = c('blue', 'cyan', 'red'))
dev.off()

pdf(file = './Fig4-e-picc-likelihood-v1-2023-10-18.pdf', width = 4, height = 5)
plot(alphas, exp(loglikelihoods) / sum(exp(loglikelihoods), na.rm = T) * 50, 'l', 
...
write.csv(data.frame(alphas = alphas, 
                     likelihoods = exp(loglikelihoods) / 
                       sum(exp(loglikelihoods), na.rm = T) * 50),
          './Fig4-e-picc-alphas-likelihoods-v1-2023-10-18.csv', fileEncoding = 'GB2312')
...
pdf(file = './Fig5-b-new-transplant-centre-surv-v1-2023-10-18.pdf', width = 4.5, height = 5)
ggsurvplot(fit1, data = df, ylim = c(0.7, 1), palette = c('blue', 'cyan', 'red'))
dev.off()

pdf(file = './Fig5-e-new-transplant-centre-likelihood-v1-2023-10-18.pdf', width = 4, height = 5)
plot(alphas, exp(loglikelihoods) / sum(exp(loglikelihoods), na.rm = T) * 50, 'l', 
...
write.csv(data.frame(alphas = alphas, 
                     likelihoods = exp(loglikelihoods) / 
                       sum(exp(loglikelihoods), na.rm = T) * 50), 
          './Fig5-e-new-transplant-centre-alphas-likelihoods-v1-2023-10-18.csv', 
          fileEncoding = 'GB2312')
